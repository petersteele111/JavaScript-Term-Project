document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("play").addEventListener("click", function () {
        ...
        document.getElementById("starterImage").style.display = "none";
        document.getElementById("breakoutCanvas").style.display = "block";

        introMusic = new Sound("media/breakout.wav");
        introMusic.play();
        ...
        draw();
        backgroundMusic = new BackgroundSound("media/backgroundSongLoop.wav");
